      <div class="modal fade text-left show" id="editStatus" tabindex="-1" role="dialog" aria-labelledby="basicModalLabel3" aria-modal="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
              {!! Form::open(['method'=>'PATCH', 'action'=>['StatusController@update', $status->id],  'id'=>'editStatus', 'files'=>true]) !!}
              <div class="modal-content">
                  <div class="modal-header bg-gradient-directional-pink">
                      <h4 class="modal-title text-center font-large-1 text-white" id="basicModalLabel3">EDIT STATUS</h4>
                  ...
                  <div class="modal-footer bg-gradient-directional-pink">
                      {!! Form::submit('Update Status', ['class'=>'btn btn-icon btn-bg-gradient-x-blue-green mr-1 shadow-lg float-left', 'id'=>'btnSubmit']) !!}
